...
| 模块 | 推荐型号 | 参考价格 | 购买渠道 |
|------|---------|---------|---------|
| 主控板 | NodeMCU V2 (ESP8266 ESP-12F) | ¥15 | 淘宝 |
| 舵机 ×4 | SG90 180° | ¥20 (共) | 淘宝 |
| OLED 屏幕 | SSD1306 128×64 I2C 白色 | ¥10 | 淘宝 |
| 摄像头 | OV2640 (ArduCAM Mini) | ¥25 | 淘宝 |
| 语音模块 | HLK-V20 (SU-03T) | ¥15 | 淘宝 |
| 扬声器 | 8Ω 0.5W 小喇叭 | ¥3 | 淘宝 |
| 三极管 | S8050 或 2N2222 | ¥0.5 | 淘宝 |
| 电池 | 2S 锂电池 7.4V (1000mAh) | ¥30 | 淘宝 |
| 升压模块 | MT3608 (可选，稳压用) | ¥5 | 淘宝 |
| PCB 打样 | 嘉立创免费 | ¥0~5 | 嘉立创 |
| 3D 打印 | 嘉立创 / 淘宝 | ¥0~20 | 嘉立创 |
| USB-TTL | CH340G | ¥8 | 淘宝 |
| **总计** | | **≈ ¥130~¥150** | |

> 💡 对于新手，建议先买主控板 + USB-TTL + OLED，**只烧录固件看能不能跑起来**，再逐步加舵机和其他模块。
